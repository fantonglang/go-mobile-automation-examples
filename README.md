...
5. [这里](./douyin-luo-live/main.go) 是示例 main.go 文件
...
## 例子
[这里](./douyin-luo-live) 是一个能跑起来的例子。仔细阅读main函数的注释，里面有手机设置，环境安装，编译，调试，部署，执行的教程。
...
| ![image](./doc/wechat.jpg) | ![image](./doc/wechat2.jpg) |
| -- | -- |